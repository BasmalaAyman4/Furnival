        ...
        <>
            <section>
                ...
                <Container>
                    ...
                    <Button variant="primary" onClick={handleShow} className={`${styles.btnModel}`}>
                        Show Filter
                    </Button>

                    <Modal show={show} onHide={handleClose} scrollable={true} className={`${styles.shopFilterModel}`} >
                        <Modal.Header closeButton >
                        </Modal.Header>
                        <Modal.Body>
                            <Col sm={12} data-aos="fade-left">
                    ...
                    <Row>
                        <Col md={3} className={`${styles.shopFilter}`} data-aos="fade-up">
                            <h2 className={`${styles.filter__title}`}>filter by :</h2>
                            <p className={`${styles.filter__para}`}>price</p>
                            <div>
                                <label>Price (between 5000 and 25000)</label>
